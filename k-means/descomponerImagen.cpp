...
int main (int argc, char* argv[])
{
	...
	time(&_initTime);
	double compactness = cv::kmeans(data, NCLUSTER, _vCluster, cv::TermCriteria(cv::TermCriteria::EPS + cv::TermCriteria::MAX_ITER, 10, 0.01/*20, 1E-5*/), 3, cv::KMEANS_PP_CENTERS, _centers);
